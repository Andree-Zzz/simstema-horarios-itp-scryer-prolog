/* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
   ...
   Este programa esta basado el trabajo hecho por Markus Triska:
   
	   Simsttab -- Simplistic school time tabler
	   Copyright (C) 2005-2022 Markus Triska.

  Probado en Scryer Prolog.
- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
...
align_rows([]) --> "Diurno: 8:00am-12:00m - Nocturno: 6:30pm-10:30pm\n\n\n".
align_rows([R|Rs]) -->
        align_row(R),
        "1-hora\n",
        align_rows(Rs).
